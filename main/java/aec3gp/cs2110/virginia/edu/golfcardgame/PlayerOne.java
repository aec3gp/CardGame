...
public class PlayerOne {
    ...
    public PlayerOne(CardGame.OurView view, Bitmap b, ArrayList<Card> topHand, ArrayList<Card> bottomHand){
        this.view = view;
        this.cards = b;
    ...
    public void onDraw(Canvas canvas){
        ...
        for(int i = 0; i < 4; i++){
            ...
            Rect src = new Rect( suitNumber * this.top.get(i).getHeight(), (this.top.get(i).number - 1) * this.top.get(i).getWidth(), (suitNumber * this.top.get(i).getHeight()) + this.top.get(i).getHeight(), this.top.get(i).number * this.top.get(i).getWidth()); // srcY
            if( i == 0){
                x = this.top.get(i).height;
            ...
            if(this.top.get(i).flipped == true){
                ...
                src = new Rect(0 , 0, top.get(i).height, top.get(i).width);
                canvas.drawBitmap(cards, src, dst, null);
            }
        ...
        for(int i = 0; i < 4; i++){
            ...
            Rect src = new Rect( suitNumber * this.bottom.get(i).getHeight(), (this.bottom.get(i).number - 1) * this.bottom.get(i).getWidth(), (suitNumber * this.bottom.get(i).getHeight()) + this.bottom.get(i).getHeight(), this.bottom.get(i).number * this.bottom.get(i).getWidth()); // srcY
            if( i == 0){
                x = 0;
                y = this.height + this.top.get(i).getWidth();
            }
